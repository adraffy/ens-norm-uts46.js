...
var DATA = {
	"IDNA": {
		...
		"mapped": [
			...
			[
				"3319",
				"30B0 30E9 30E0 30C8 30F3"
			],
			[
				"331A",
				"30AF 30EB 30BC 30A4 30ED"
			],
			[
				"331B",
				"30AF 30ED 30FC 30CD"
...
function nfc_native(cps) {
	return explode_cp$1(String.fromCodePoint(...cps).normalize('NFC'));
}
...
function create_uts46({
	...
	return function(name) {
		...
		// [Processing] 1.) Map
		let input = explode_cp$1(name).reverse(); // flip so we can pop
		let output = [];
		while (input.length) {
			let cp = input.pop();
...
function read_idna_rules({version, use_STD3, valid_deviations}) {
	switch (version) {
		case 2003:
		case 2008: break;
...
function validate_contextJ(cps) {
...
exports.create_uts46 = create_uts46;
exports.escape_unicode = escape_unicode;
exports.explode_cp = explode_cp$1;
exports.is_surrogate = is_surrogate;
exports.parse_cp = parse_cp;
exports.parse_cp_range = parse_cp_range;
exports.parse_cp_sequence = parse_cp_sequence;
...
exports.read_idna_rules = read_idna_rules;
exports.validate_bidi_label = validate_bidi_label;
exports.validate_contextJ = validate_contextJ;
exports.validate_contextO = validate_contextO;
