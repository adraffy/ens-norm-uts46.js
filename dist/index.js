...
async function read_idna_rules({version, use_STD3, valid_deviations}) {
	switch (version) {
		case 2003:
		case 2008: break;
...
export { create_uts46, escape_unicode, explode_cp, parse_cp, parse_cp_range, parse_cp_sequence, puny_decode, puny_encode, read_idna_rules, validate_bidi_label, validate_contextJ, validate_contextO };
